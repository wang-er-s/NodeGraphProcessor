...
namespace ET
{
    ...
    {
        [BsonIgnore] private Dictionary<int, StartSceneConfig> dict = new Dictionary<int, StartSceneConfig>();

        [BsonElement] private List<StartSceneConfig> list = new List<StartSceneConfig>();
