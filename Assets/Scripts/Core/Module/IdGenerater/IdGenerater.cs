    ...
    public class IdGenerater : Singleton<IdGenerater>
    {
        ...
        public long GenerateInstanceId()
        {
            ...
            InstanceIdStruct instanceIdStruct =
                new InstanceIdStruct(this.lastInstanceIdTime, Options.Instance.Process, this.instanceIdValue);
        ...
        public long GenerateUnitId(int zone)
        {
            ...
            UnitIdStruct unitIdStruct =
                new UnitIdStruct(zone, Options.Instance.Process, this.lastUnitIdTime, this.unitIdValue);
