...
public class EdgeFlowPointCaculator
{
    ...
    {
        var firstFragmentLength = Vector2.Distance(edgePoints[1], edgePoints[0]);
        var firstFragmentPercentage = firstFragmentLength / totalEdgeLength;
        ...
        {
            var percentageInSecondFragment =
                (percentage - firstFragmentPercentage) / (1 - 2 * firstFragmentPercentage);
        ...
        {
            var reversePercentageInThirdFragment = 1 - percentage;
