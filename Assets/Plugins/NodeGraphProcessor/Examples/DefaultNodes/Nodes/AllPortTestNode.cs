...
[Serializable]
[NodeMenuItem("Custom/AllPortTestNode")]
public class AllPortTestNode : BaseNode
{
    ...
    [Output(name = "output_List")] [ShowPortIcon(ShowIcon = true, IconNameMatchedInUSSFile = "Object")]
    public List<string> output_List;

    [Output(name = "output_IfCondition")] [ShowPortIcon(ShowIcon = true, IconNameMatchedInUSSFile = "IfCondition")]
    public bool output_IfCondition;

    [Output(name = "output_ForEach")] [ShowPortIcon(ShowIcon = true, IconNameMatchedInUSSFile = "ForEachLoop")]
    public bool output_ForEach;

    [Output(name = "output_WhileLoop")] [ShowPortIcon(ShowIcon = true, IconNameMatchedInUSSFile = "WhileLoop")]
    public bool output_WhileLoop;

    [Output(name = "output_Action")] [ShowPortIcon(ShowIcon = true, IconNameMatchedInUSSFile = "Action")]
    public bool output_Action;
    ...
    [Output(name = "output_Matrix4x4")] [ShowPortIcon(ShowIcon = true, IconNameMatchedInUSSFile = "Matrix")]
    public Matrix4x4 output_Matrix4x4;
    ...
    [ShowPortIcon(IconNameMatchedInUSSFile = "Array")]
    [TableMatrix(HorizontalTitle = "input_Array")]
    public int[,] input_Array = new int[3, 3];

    [Input(name = "input_Object")] public object input_Object;

    [Output(name = "output_Dictionary")] [ShowPortIcon(ShowIcon = true, IconNameMatchedInUSSFile = "Object")]
    public Dictionary<string, string> output_Dictionary;

    [Input(name = "input_HashSet")] [ShowPortIcon(ShowIcon = true, IconNameMatchedInUSSFile = "Object")]
    public HashSet<string> output_HashSet;
