...
namespace GraphProcessor
{
    ...
    public abstract class BaseNode
    {
        ...
        [NonSerialized] private readonly List<string> messages = new();

        [HideInInspector] public string nodeCustomName; // The name of the node in case it was renamed by a user
                ...
                if (HasCustomBehavior(nodeField))
                    ...
                    AddPort(nodeField.input, nodeField.fieldName,
                        new PortData
                        {
                            ...
                            showPortIcon = nodeField.showPortIcon, portIconName = nodeField.portIconName
                        });
            }
        }
        ...
        private void InitializeInOutDatas()
        {
            ...
            foreach (var field in fields)
            {
                ...
                nodeFields[field.Name] = new NodeFieldInformation(field, name, input, isMultiple, tooltip,
                    vertical != null, null, _showPortIcon, _portIconName);
            }
        ...
        {
            Debug.LogError($"{GetType()} 未重写TryGetOutputValue函数，将无法正确获取输出值");
        }
